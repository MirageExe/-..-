...
cmd-adduplink-desc = Создаёт аплинк на выбранный предмет и привязывает его к аккаунту пользователя.
...
add-uplink-command-completion-2-uplink-bearer = Носитель аплинка (по умолчанию ПДА игрока)
