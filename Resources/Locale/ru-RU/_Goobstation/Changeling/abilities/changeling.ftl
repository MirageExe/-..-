...
changeling-stasis-finished = Наш стазис завершён. Мы готовы пробудиться.
...
changeling-action-fail-onfire = Наши клетки корчатся в агонии, мы не в состоянии выполнить действие!
changeling-action-fail-lesserform = Не можем выполнить действие, находясь в этой форме!
changeling-action-fail-absorbed = Нужно поглотить ещё {$number} генов, что-бы использовать это!
changeling-action-fail-not-changeling = Бро. Ты не должен иметь это действие. Сообщи об ошибке разработчикам.
