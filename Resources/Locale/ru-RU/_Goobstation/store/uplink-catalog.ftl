...
uplink-grey-tide-desc = Древний артефакт с магическими характеристиками. Идентичен плазменному копью, но способен вызвать иллюзию при попадании по живым существам, если владелец является ассистентом.
uplink-adv-mimery-name = Руководство продвинутой пантомимы 
uplink-adv-mimery-desc = Классическая серия из двух частей о том, как еще больше отточить свои навыки мима. После изучения этой серии пользователь должен уметь создавать невидимые стены размером 3х1 и стрелять пулями из пальцев.
